...
CREATE TABLE IF NOT EXISTS  `user_address` (
  ...
  `details` varchar(40) NOT NULL COMMENT '详细地址',
  `receiver` varchar(10) NOT NULL DEFAULT '' COMMENT '收件人',
...
ALTER TABLE `order` ADD INDEX pid_index(pid);
ALTER TABLE `product` ADD INDEX product_index(parent_product_name, product_name);
